...
- Choose hooks by `docs/ARCHITECTURE.md` §3 execution order; respect all CLAUDE.md correctness rules (FightCharacter/ForOneFight, MinusPsycheLog, buffered vs bonus points, ban carve-outs, transferred-passive immunity).
