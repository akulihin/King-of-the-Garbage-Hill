...
| Эрен state | owner-only `ErenStateDto`: gained Rage, **round-10 Rumbling losses**, Titan/Tatake audio serials, Rumbling result, and an aggregation of all per-player hatred marks | `GameStateDto.cs:749-767` `GameStateMapper.cs:372-396` |
