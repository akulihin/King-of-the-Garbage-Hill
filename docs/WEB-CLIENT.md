...
> Code-verified against the working tree of 2026-07-11 (v4.3.2). Companion docs: [WEB-BACKEND.md](WEB-BACKEND.md) (the server this SPA talks to), [ARCHITECTURE.md](ARCHITECTURE.md) (§6 state→screen, §7 the per-character 14-file pattern — steps 13-14 land here), [DISCORD-INTERFACE.md](DISCORD-INTERFACE.md), and [DAILY-QUESTS.md](DAILY-QUESTS.md). Client root: `Web/VueClient/`. All anchors below are into `Web/VueClient/src/` unless the file name says otherwise.
