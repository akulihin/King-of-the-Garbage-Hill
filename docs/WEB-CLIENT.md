...
| `PassiveAbilityStates` | owner-only widget contract, including `doomGuy`; its shape carries roll mode/availability, current options, active modules, nest names, BFG charge and Chainsaw choices | `signalr.ts:129-173, 668-696` |
