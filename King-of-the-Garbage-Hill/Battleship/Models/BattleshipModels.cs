...
public class BattleshipGame
{
    ...
    /// <summary>
    /// Automatic weapon impacts which are not player shot actions (for example Fortune's
    /// boarding broadside). The transport may drain this queue for projectile animations.
    /// </summary>
    public Queue<ShotResult> PendingAutomaticShotEvents { get; set; } = new();
...
public class BattleshipPlayer
{
    ...
    /// <summary>
    /// Captain Flint's finite Cannon and Fortuna pools. Living operational armed decks
    /// determine and clamp the maximum; Warming weapons remain individually unlimited.
    /// </summary>
    public Dictionary<ShotType, int> SharedFlintWeaponAmmo { get; set; } = new();
    /// <summary>Prevents a destroyed or delayed mirror-match Parrot from spawning again.</summary>
    public bool FlintParrotSpawned { get; set; }
...
public class Summon
{
    ...
    /// <summary>
    /// Public presentation position for Parrot. Its authoritative Row/Col may already occupy
    /// the armed destination while the visual remains at these coordinates.
    /// </summary>
    public int VisualRow { get; set; } = -1;
    public int VisualCol { get; set; } = -1;
    /// <summary>Parrot is visually blurred while its hitbox waits in the predicted cell.</summary>
    public bool IsPhantom { get; set; }
    /// <summary>True after a Parrot destination is chosen and before that arrival resolves.</summary>
    public bool ParrotMoveArmed { get; set; }
}
...
public class ShotResult
{
    ...
    /// <summary>True for a projectile generated by a passive rather than a player shot action.</summary>
    public bool IsAutomaticShot { get; set; }
    /// <summary>Server-side actor identity used to personalize hidden projectile origins.</summary>
...
public class ShipDefinition
{
    ...
    /// <summary>Mid hulls normally receive one Ballista per deck unless explicitly suppressed.</summary>
    public bool SuppressAutomaticBallistas { get; set; }
