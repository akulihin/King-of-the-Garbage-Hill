...
- Forcing fights on blocking/skipping players works via `WhoToAttackThisTurn` (the fight loop processes forced fights); respect the round-10 Тигр-ban carve-out pattern (`CheckIfReady.cs:1448-1461`).
