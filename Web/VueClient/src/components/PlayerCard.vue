  ...
  >
    ...
    <div v-if="passiveStates?.gordon" class="pc-passive-widget gordon-widget" :data-widget-help="widgetHelp('gordon')" :aria-description="widgetHelp('gordon')" tabindex="0">
      <div class="pw-header gordon-header">
        <span class="pw-title gordon-title">BLACK MESA // GORDON</span>
...
/* Gordon Freeman — Black Mesa telemetry */
.gordon-widget {
  overflow: hidden;
...
.gordon-metrics { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 5px; margin-top: 8px; }
