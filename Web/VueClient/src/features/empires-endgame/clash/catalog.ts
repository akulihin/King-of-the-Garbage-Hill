...
export const CLASH_ROSTER: ClashUnitDefinition[] = [
  ...
  unit({ id: 'organ', name: 'ОргАн', faction: 'Хаотичный', regions: ['common'], attack: null, maxHp: null, speed: null, tags: ['boss'], reviewReason: 'Named boss carrier has no complete pre-cutoff battle contract.', sourceMessageIds: ['1382288986579664916'] }),
